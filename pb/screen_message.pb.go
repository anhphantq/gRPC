...
type Screen_Pannel int32

const (
	Screen_UNKNOWN Screen_Pannel = 0
	Screen_IPS     Screen_Pannel = 1
	Screen_OLED    Screen_Pannel = 2
)

// Enum value maps for Screen_Pannel.
var (
	Screen_Pannel_name = map[int32]string{
		0: "UNKNOWN",
		1: "IPS",
		2: "OLED",
	}
	Screen_Pannel_value = map[string]int32{
		"UNKNOWN": 0,
		"IPS":     1,
		"OLED":    2,
	}
...
func (x Screen_Pannel) Enum() *Screen_Pannel {
	p := new(Screen_Pannel)
	*p = x
	return p
}

func (x Screen_Pannel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Screen_Pannel) Descriptor() protoreflect.EnumDescriptor {
	return file_screen_message_proto_enumTypes[0].Descriptor()
}

func (Screen_Pannel) Type() protoreflect.EnumType {
	return &file_screen_message_proto_enumTypes[0]
}

func (x Screen_Pannel) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Screen_Pannel.Descriptor instead.
func (Screen_Pannel) EnumDescriptor() ([]byte, []int) {
...
type Screen struct {
	...
	Pannel     Screen_Pannel      `protobuf:"varint,3,opt,name=pannel,proto3,enum=Screen_Pannel" json:"pannel,omitempty"`
...
func (x *Screen) GetPannel() Screen_Pannel {
	if x != nil {
		return x.Pannel
	}
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65,
	...
	0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x06, 0x70, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x50, 0x61, 0x6e, 0x6e,
	0x65, 0x6c, 0x52, 0x06, 0x70, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x75,
	0x6c, 0x74, 0x69, 0x74, 0x6f, 0x75, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	0x6d, 0x75, 0x6c, 0x74, 0x69, 0x74, 0x6f, 0x75, 0x63, 0x68, 0x1a, 0x3a, 0x0a, 0x0a, 0x52, 0x65,
	0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x77, 0x69, 0x64, 0x74,
	...
	0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x28, 0x0a, 0x06, 0x50, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Pannel)(0),        // 0: Screen.Pannel
	(*Screen)(nil),            // 1: Screen
...
var file_screen_message_proto_depIdxs = []int32{
	...
	0, // 1: Screen.pannel:type_name -> Screen.Pannel
